    ...
    */
    ...
    promise_to_require : function(module_or_path, options){// load script into iframe to create closed namespace
        ...
        if(typeof this._cache.promise[module_or_path] == "undefined"){ // if not in cache, build into cache
            ...
            this._cache.promise[module_or_path] = {promise_content: promise_content, promise_path : promise_path, default_options_functions : promise_default_options_functions}; // cache the promise (and consequently the result)
        }
    ...
    synchronous_require : function(request){
        // NOTE - synchronous_require is ONLY usable from required scripts and is automatically injected; no options
